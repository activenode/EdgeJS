...
(function (Edge) {
    ...
    (function (FileUploader) {
        ...
        var FileParcel = (function () {
            function FileParcel(container, uploadManager) {
                ...
                this.serverSaveData = null; //holds the data that is important to THIS file (if given)
                this.destroyed = false;
                this.uploadXhr = null; //is always null when fileAPI is NOT (!) used
                this.correspondingIframe = null; //is always NULL when fileAPI is used
                this.linkedChildren = [];
        ...
        var UploadManager = (function () {
            ...
            UploadManager.prototype.listenForResize = function (bReposition) {
                var self_ref = this;
                var repos = function () {
                    ...
                    self_ref.filesElem.css('width', width + 'px').css('height', height + 'px');
                    if (bReposition) {
                        self_ref.filesElem.css('top', coords.top + 'px').css('left', coords.left + 'px');
                    }
                };
    ...
    })(FileUploader = Edge.FileUploader || (Edge.FileUploader = {}));
})(Edge || (Edge = {}));
